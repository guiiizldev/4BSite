...
const RestaurantFloorPage = lazy(() => import("@/pages/Admin/RestaurantFloorPage"));
...
const PROFILE_AVATAR_STORAGE_KEY = "4bytsfood.profile.avatar";
const ACTIVE_PAGE_STORAGE_KEY = "4bytsfood.activePage";
const THEME_STORAGE_KEY = "4bytsfood.theme";
const POS_TAB_NAME = "4bytsfood-pdv-tab";
...
export default function App() {
  ...
  const pageTitleByKey: Record<PageKey, string> = {
    home: "Home",
    "salao-comandas": "Salão e Comandas",
  ...
  useEffect(() => {
    if (activePage === "vendas" && isStandalonePos) {
      document.title = "4Byts PDV — Frente de caixa";
      return;
    }
    document.title = "4Byts Food — Restaurante, lanchonete e bar";
  }, [activePage, isStandalonePos]);
