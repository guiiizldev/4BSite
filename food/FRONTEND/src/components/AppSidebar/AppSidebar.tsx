        ...
        <div className="flex items-center justify-between p-4 border-b border-border-primary">
          {!collapsed && (
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-sm font-bold tracking-tight text-accent">FOOD</h1>
        ...
        <nav className="flex-1 min-h-0 space-y-3 overflow-y-auto overflow-x-hidden px-2 py-3 text-sm font-medium">
          <div className="space-y-2">
            ...
            <SidebarItem
              ...
              label="Salão e Comandas"
              active={activePage === "salao-comandas"}
              collapsed={collapsed}
              onClick={() => handleChangePage("salao-comandas")}
            />
          </div>
