    ...
    <main className="relative isolate min-h-screen overflow-hidden bg-bg-primary px-4 py-8 text-text-primary md:px-6 lg:px-8">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-5xl items-center justify-center">
        <section className="card auth-login-card grid w-full overflow-hidden border-white/45 bg-white/85 backdrop-blur-sm lg:grid-cols-[0.9fr_1.1fr]">
          <div className="hidden bg-gradient-to-br from-[#07110f] to-[#0c3b2e] p-8 text-white lg:flex lg:flex-col lg:justify-between">
            <div>
              <BrandLogo variant="dark" className="h-[60px] w-[120px]" />
              <p className="mt-5 text-xs font-bold uppercase tracking-[0.2em] text-[#2be3a9]">4Byts Food</p>
              <h1 className="mt-4 text-3xl font-bold leading-tight">
                Mesas, comandas e pedidos em um fluxo rápido para sua operação.
              </h1>
            </div>

            <p className="text-sm text-white/85">
              Controle salão, atendimento, cozinha, caixa e relatórios em um único painel.
            </p>
          </div>
