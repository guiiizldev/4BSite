...
{
    public static LicenseActivationResult Development() => new(true, "", "development", new(0, "4Byts Food", "Desenvolvimento", "active", 1, null));
}
public sealed record LicenseValidationResult(bool Valid, string Error, CentralLicenseDto? License)
{
    public static LicenseValidationResult Development() => new(true, "", new(0, "4Byts Food", "Desenvolvimento", "active", 1, null));
}
